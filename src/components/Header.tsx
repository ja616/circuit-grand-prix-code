...
const Header = () => {
  ...
  return (
    <header className="bg-gradient-to-r from-[#8e44ad] to-[#ff3e3e] text-white sticky top-0 z-50 py-4">
      <div className="max-w-screen-xl mx-auto px-4"> {/* Adjust max width and padding */}
        <div className="flex items-center justify-between">
          {/* Desktop navigation (aligned left) */}
          <nav className="flex items-center space-x-6 mr-auto"> {/* Align left with reduced gap */}
          ...
          {/* Logo on the right */}
          <Link to="/" className="flex items-center ml-4"> {/* Adjusted margin */}
            <img 
